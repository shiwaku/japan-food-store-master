...
/** 点レイヤーの縁色。淡色は白抜き、写真・ダークは暗い縁のほうが点が締まる。 */
export function haloColor(base: Basemap, theme: Theme): string {
  if (base === "photo") return "rgba(255,255,255,0.9)";
  return theme === "dark" ? "rgba(10,12,16,0.85)" : "#ffffff";
}
